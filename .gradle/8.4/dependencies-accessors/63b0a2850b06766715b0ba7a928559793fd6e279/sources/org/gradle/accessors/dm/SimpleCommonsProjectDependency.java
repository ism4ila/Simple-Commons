...
@NonNullApi
public class SimpleCommonsProjectDependency extends DelegatingProjectDependency {

    @Inject
    public SimpleCommonsProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
